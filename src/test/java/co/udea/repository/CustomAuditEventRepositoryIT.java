package co.udea.repository;

import co.udea.AeropuertoApp;
import co.udea.config.Constants;
import co.udea.config.audit.AuditEventConverter;
import co.udea.domain.PersistentAuditEvent;
...
import static co.udea.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
